package org.fedelaper.spring.filter;
 ...
 * 
 * <b>Package:</b> org.fedelaper.spring.filter<br/>
 * 
...
public class CORSFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (request.getHeader(HEADER_ACCESS_CONTROL_REQUEST_METHOD) != null && REQUEST_METHOD.equals(request.getMethod())) {
			...
			// IMPORTAN: here you shoud add ALL THE REQUIRED HTTP HEADERS TO BE USED.
